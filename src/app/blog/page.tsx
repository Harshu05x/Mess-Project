...
export default function BlogArticles() {
    ...
    const categories = ["All", "Healthy Eating", "Meal Planning", "Mess Owner Spotlight", "Recipes", "Nutrition"]

    return (
        <div className="min-h-screen bg-gray-100 p-8">
            <div className="max-w-6xl mx-auto space-y-8">
                <h1 className="text-3xl font-bold text-orange-600">MEAL'SPOTTER Blog</h1>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-2xl font-bold text-orange-600">Subscribe to Our Newsletter</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-gray-600 mb-4">
                            Stay updated with the latest articles, recipes, and tips from MEAL'SPOTTER.
                        </p>
...
function ArticleCard({ title, excerpt, author, date, category, image }: ArticleCardProps) {
    return (
